...
`core-js` isn't backed by a company, so the future of this project depends on
you. [Become a sponsor or a backer](#sponsorship-channels) if you are interested
in `core-js`:
...
- Alipay: ![Alipay-code](/sponsor/alipay.webp)
